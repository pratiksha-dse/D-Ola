...
class _RegistrationPageState extends State<RegistrationPage> {
  void validateForm() {
    if (username.length != 0 && password.length > 5 && phone.length!=10 && (role=='Rider' || (role=='Driver' && public_key_driver!=''))) {
      formCompleted = true;
    } else {
      formCompleted = false;
    }
                      ...
                      children: [
                        ...
                        TextField(
                          ...
                          decoration: customBoxStyle.copyWith(
                              ...
                              hintText: 'Minimum 10 characters requires'),
                        ),
                        SizedBox(height: 15.0),
                        GestureDetector(
                          onTap: () async {
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                color: formCompleted
                                    ? Color(0xff14279B)
                                    : Color(0xff14279B).withOpacity(0.5)),
                          ),
                        ),
                      ]),
                )
